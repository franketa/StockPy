...
stocks = web.DataReader('AMZN', 'yahoo', start, end)
stocks_close = pd.DataFrame(web.DataReader(
    'AMZN', 'yahoo', start, end)['Close'])
stocks2 = pd.DataFrame(web.DataReader('AMZN', 'yahoo', start, end))
print(stocks2['Close'])
#stocks2['Close','AMZN'] = stocks2.rolling(5).mean()
